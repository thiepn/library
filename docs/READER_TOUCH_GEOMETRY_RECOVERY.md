...
This narrower disambiguation intentionally preserves the previously qualified synthetic and iframe-local acceptance paths while addressing only the retained staged physical-touch evidence.
