...
if (present) {
  ...
  pass(
    ...
    store.includes("openLibraryDb") && store.includes("objectStoreNames.contains('annotations')") && db.includes('const DB_VERSION = 6'),
    'Native annotations reuse the existing IndexedDB annotations store without a destructive database-version bump',
  );
  pass(
